...
<!-- 창 줄었을 시 변화 -->
 <div class="navbar-header">
  ...
  <a class="navbar-brand" href="${path}/semi_project/index.jsp">K-Sights</a>
 </div>
    ...
    <ul class="dropdown-menu mega-dropdown-menu row">
	 ...
	 <li class="col-sm-3">
	  <ul>
	   ...
	   <li><a href="${path}/semi_project/nboard/nboard_index.jsp">전체목록</a></li>
...
<!-- 점보트론 -->
<div class="jumbotron" style="border: 1px solid black; background-size : cover; background-position: center; background-image: url('/myweb/semi_project/images/k-pop.jpg'); height: 300px; width: 100%;  background-repeat : no-repeat;">
