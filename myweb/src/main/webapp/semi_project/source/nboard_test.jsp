...
$(function(){
	$("#btnWrite").click(function(){
		location.href = "/myweb/semi_project/nboard/nboard_write.jsp";
	});
	...
	$("#btnList").click(function(){
		location.href = "/myweb/semi_project/nboard/nboard_index.jsp";
	});
	$("#btnDelete").click(function(){
		document.deleteform.action="${path}/SP_ksight_nboard/delete.do";
...
function search_keyword(){
	...
	if(keyword != ""){
		location.href = "${path}/SP_ksight_nboard/list.do?keyword="+keyword;
	}
}
function list(page){
