            ...
            <div class="panel panel-default panel-table">
              ...
              <div class="panel-body">
                <table class="table table-striped table-bordered table-list">
                  <thead>
                    <tr>
                        <th><img src="/myweb/semi_project/images/gear.svg"> </th>
                  ...
                  <tbody>
                          <tr>
                            <td align="center">
                              <a class="btn btn-default"><img src="/myweb/semi_project/images/pencil-square.svg"></a>
                              <a class="btn btn-danger"><img src="/myweb/semi_project/images/trash3-fill.svg"></a>
                            </td>
...
<section class="book_section layout_padding">
  ...
  <!-- Content page -->
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
         <div class="item active">
          <a href="#"><img src="${path}/semi_project/images/woo2.png" class="img-responsive" alt="product 1"></a>
          <h4><small>1번링크의 제목</small></h4>                                        
          <button class="btn btn-primary" type="button">버튼1</button> <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> 버튼2</button>       
         </div><!-- End Item -->
         <div class="item">
          <a href="#"><img src="${path}/semi_project/images/woo2.png" class="img-responsive" alt="product 2"></a>
          <h4><small>Gold sandals with shiny touch</small></h4>                                        
         ...
         <div class="item">
          <a href="#"><img src="${path}/semi_project/images/woo2.png" class="img-responsive" alt="product 3"></a>
          <h4><small>Denin jacket stamped</small></h4>                                        
