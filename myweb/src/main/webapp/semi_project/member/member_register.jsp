...
function idOutfo(){
	var email_Log = $("#emailId").val();
	var checkEmail = /^[a-z0-9]{2,}@[a-z0-9]{2,}\.[a-z]{2,}$/;
	var msg;
	if(email_Log == ""){
		msg = "이메일주소를 입력하세요.";
		document.getElementById("idinfo").innerHTML = msg;
	}else if(!checkEmail.test(email_Log)) {
		msg = "잘못 입력하셨습니다.";
		document.getElementById("idinfo").innerHTML = msg;
	}else{
...
<div class="container">
       ...
       <div class="col-lg" style="margin: auto; width: 75%;"> 
        <form method="post" name="registerform">
         <div class="row mb-3">
          ...
          <div class="col-sm-10">
           <input type="email" class="form-control" name="emailId" id="emailId" placeholder="이메일주소를 입력하세요" onblur="idOutfo()">
           <div id="idinfo"></div>
          </div>
         </div>
         ...
         <div class="row mb-3">
          ...
          <div class="col-sm-4">
           <input class="form-control" name="member_name" id="member_name" placeholder="한글,영문,숫자가능">
          </div>
          <label for="gender" class="col-sm-2 col-form-label">Gender</label>
          <div class="col-sm-4">
           남성 <input type="radio" class="form-control-sm" name="gender" value="m">
            / 여성 <input type="radio" class="form-control-sm" name="gender" value="f">
          </div>
         </div>
         <hr style="margin: 10px;">
         ...
         <div class="row mb-3">
          ...
          <div class="col-sm-10">
           <input class="form-control" name="phone" id="phone" placeholder="010-0000-0000">
          </div>
         </div>
         <hr style="margin: 10px;">
         ...
         <div class="row mb-3">
          ...
          <div class="col-sm-10">
           <input class="form-control" name="birthday" id="birthday" placeholder="yyyyMMdd 8자리 입력">
          </div>
         </div>
         <hr style="margin: 10px;">
        ...
        <div align="center">
        <a href="#" class="btn btn-info btn-lg" onclick="register()">회원가입하기</a>
        </div>
       </div>
      </div>
     </div>
 ...
 function register(){
		...
		if(!checkId.test(emailId)){
			alert("아이디는 이메일로 입력하세요. ex)abc@abc.com");
			$("#emailId").focus();
			return;
		}
		if(pwd == ""){
		...
		document.registerform.action = "${path}/SP_ksight_member/register.do";
