...
public class MybatisManager {
    ...
    /*
     * 생성자 보통 public인데 private처리 했다. 따라서 외부에서 접근이 안된다.
     * new해서 접근 안되기 때문에  getInstance()우회 접속한다.
	...
	public static SqlSessionFactory getInstance() {
		...
		try {
			...
			reader = Resources.getResourceAsReader("sqlmap/sqlMapConfig.xml"); //inputstream이라함...
